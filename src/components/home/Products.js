    ...
    >
      <div className="Container1240">
        <div className="w-[317px] mx-[auto] lg:w-[unset]">
          ...
          <p
            data-aos="fade-down"
            className="text16 text-[#FBFBFB] lg:mt-[1.11111111111vw] mt-[8px]"
          >
            Hadeed’s metals products are supplied under the Hadeed brand. As a
            leader in the Gulf region for steel production and manufacturing,
            Hadeed produces high- quality metals, and has played a vital role in
            the construction and industrialization of some of the world’s
            fastest growing economies. We are responsibly working towards
            reducing the environmental footprint from our operations. Hadeed SOx
            and NOx figures for 2022 are 15.4 & 707.28 tons/year respectively
          </p>
        </div>
        <div
          data-aos="fade-up"
          data-aos-delat="400"
          className="flex items-stretch justify-between flex-wrap gap-y-[40px] lg:my-[3.81944444444vw] my-[40px]"
        >
          {products.map((product, i) => (
            <div
              key={i}
              className="product_Card border20 lg:w-[41.1805555556vw] w-full overflow-hidden"
            >
              <div className="flex flex-col items-end lg:pt-[2.08333333333vw] pt-[30px]">
                <div className="text-white lg:w-[35.625vw] w-[254px] mx-[auto]">
                  ...
                  <span className="text18 f700">{product.tag}</span>
                </div>
                <img
                  src={`/images/home/products/${i + 1}.png`}
                  alt="products"
                  className="lg:mt-[3.05555555556vw] mt-[20px] w-full lg:w-[30.4861111111vw] lg:h-[15.9027777778vw] h-[175px]"
                />
              </div>
            </div>
          ))}
