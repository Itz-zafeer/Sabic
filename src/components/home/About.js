...
const About = () => {
    return (
        <section className='relative bg-[#FBFBFB] lg:pt-[12.5vw] lg:pb-[5.97222222222vw] sm:pt-[120px]  pt-[92px] pb-[220px] '>
            ...
            />
            <div data-aos='fade' className='absolute lg:leftRightFixer1 left-[50%] translate-x-[-50%] lg:translate-x-[unset] bottom-[-90px] sm:bottom-[-150px] lg:bottom-[-3.125vw] lg:w-[50.0694444444vw] lg:h-[52.7777777778vw] sm:w-[58%] sm:h-[320px] w-[334px] h-[237px]'>
            ...
            <div data-aos='fade-up' data-aos-delay='500' className='relative z-[2] Container1240 flex justify-end'>
                <div className='lg:pt-[1.31944444444vw] lg:w-[38.5416666667vw] text16 flex flex-col lg:gap-y-[1.25vw] gap-y-[25px] text-[#121212]'>
                    ...
                    <Link href='/pdf/code-of-conduct.pdf' target="_blank" download className='flex items-center lg:gap-x-[gap-x-[vw]vw] gap-x-[10px]'>
